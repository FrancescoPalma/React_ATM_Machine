...
describe( 'Utils', () => {
  ...
  describe( 'Predefined methods', () => {
    ...
    describe( 'getSumCountNotes', () => {
      ...
      it( 'returns the sum of all the available notes with £50s set to 0', () => {
    ...
    describe( 'areAnyNotesLeft', ()=> {
      ...
      it( 'returns true when withdrawal can be dispensed with ATM notes', () => {
        expect( Utils.areAnyNotesLeft( 70, notesContainer )).to.eq(true);
      });
      it( 'returns false when the ATM does not contain the correct notes combined', () => {
