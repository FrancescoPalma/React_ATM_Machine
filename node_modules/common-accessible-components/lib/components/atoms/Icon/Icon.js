...
var Icon = (function (_Component) {
    ...
    _createClass(Icon, [{
        ...
        value: function value(props) {
            var block = _config.prefix + '-' + Icon.displayName.toLowerCase();
            var extraClasses = props.className && props.className.split(' ');

            return (0, _classnames2['default'])(_extends(_defineProperty({}, block, true), Icon.getUIClasses(props), _lodash2['default'].fromPairs(_lodash2['default'].map(extraClasses, function (cName) {
                return [cName, true];
            }))));
        },
        enumerable: true
    ...
    var _Icon = Icon;
    Icon = (0, _decorators.uiFrameworkClasses)(Icon) || Icon;
    return Icon;
})(_react.Component);
