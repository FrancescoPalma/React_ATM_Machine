...
exports['default'] = function (args, _ref2) {
  var _preprocessors;
  ...
  var preprocessors = (_preprocessors = {}, _preprocessors[testFiles] = ['webpack', 'sourcemap'], _preprocessors);
  ...
  _debug2['default']('karma config %o', karmaConfig);
  return karmaConfig;
};